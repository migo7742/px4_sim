...
: ${AMENT_CURRENT_PREFIX:="/home/migo/px4_sim/install/visual_odom_bridge"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/visual_odom_bridge/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/visual_odom_bridge/environment/path.sh"
