...
: ${AMENT_CURRENT_PREFIX:="/home/migo/px4_sim/install/ego_planner"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ego_planner/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ego_planner/environment/path.sh"
