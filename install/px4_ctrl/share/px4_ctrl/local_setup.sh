...
: ${AMENT_CURRENT_PREFIX:="/home/migo/px4_sim/install/px4_ctrl"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4_ctrl/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4_ctrl/environment/path.sh"
